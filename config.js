System.config({
  ...
  map: {
    ...
    "npm:definition-header@0.1.0": {
      "joi": "npm:joi@4.9.0",
      "joi-assert": "npm:joi-assert@0.0.3",
      "parsimmon": "npm:parsimmon@0.5.1",
    ...
    "npm:detect-indent@0.2.0": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "get-stdin": "npm:get-stdin@0.1.0",
    ...
    "npm:minichain@0.0.1": {
      "ministyle": "npm:ministyle@0.1.4",
      "miniwrite": "npm:miniwrite@0.1.4"
    },
    "npm:minimatch@1.0.0": {
    ...
    "npm:tsd@0.6.5": {
      ...
      "definition-header": "npm:definition-header@0.1.0",
      "detect-indent": "npm:detect-indent@0.2.0",
      "diff": "npm:diff@1.4.0",
      ...
      "json-pointer": "npm:json-pointer@0.2.2",
      "lazy.js": "npm:lazy.js@0.3.2",
      "lru-cache": "npm:lru-cache@2.5.2",
      "minimatch": "npm:minimatch@1.0.0",
      "minimist": "npm:minimist@1.2.0",
      "ministyle": "npm:ministyle@0.1.4",
      "minitable": "npm:minitable@0.0.4",
      "miniwrite": "npm:miniwrite@0.1.4",
      "mkdirp": "npm:mkdirp@0.5.1",
      "open": "npm:open@0.0.5",
      "os": "github:jspm/nodelibs-os@0.1.0",
      ...
      "type-detect": "npm:type-detect@0.1.2",
      "universal-analytics": "npm:universal-analytics@0.3.9",
      "update-notifier": "npm:update-notifier@0.2.2",
      "uri-templates": "npm:uri-templates@0.1.9",
      "url": "github:jspm/nodelibs-url@0.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0",
      "uuid": "npm:uuid@2.0.1",
      "verror": "npm:verror@1.4.0",
      "zlib": "github:jspm/nodelibs-zlib@0.1.0"
    },
    ...
    "npm:verror@1.4.0": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "extsprintf": "npm:extsprintf@1.0.3",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
